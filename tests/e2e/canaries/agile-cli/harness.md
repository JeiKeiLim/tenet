...
- Slice 2 must EXTEND slice 1, not rewrite it. Slice 1's tests must keep passing after slice 2 lands.
...
- Argv parsing: simple manual scan for `--pretty`; do not pull in a CLI library.
