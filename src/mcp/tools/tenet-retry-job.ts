  ...
  registerTool(
    'tenet_retry_job',
    {
      description:
        ...
        'DAG linkage and increments the retry count. A job whose retry budget is exhausted ' +
        'throws instead of re-running. The retry budget may be finite or unlimited, ' +
